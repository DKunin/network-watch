...
Веб-интерфейс собран в единый экран без прокрутки на десктопе: список устройств, почасовая активность за выбранную дату и семидневный график находятся рядом. Управление Telegram-уведомлениями в интерфейсе не отображается.
